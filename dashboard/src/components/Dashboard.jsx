...
const Dashboard = () => {
  ...
  useEffect(()=> {
    const fetchAppointments = async() => {
      try {
        const {data} = await axios.get("http://localhost:4000/api/v1/appointment/showAppointments" , {withCredentials: true})
    ...
    <div className="banner">
      <div className="firstBox">
        ...
        <div className="content">
          ...
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda suscipit sequi facilis ut temporibus sapiente illum recusandae aut.
          </p>
        </div>
      </div>
              ...
              appointments.map(appointment => {
                return (
                  <tr key={appointment._id}>
                    ...
                    <td>
                      <select className={appointment.status === "Pending" ? "value-pending" : appointment.status === "Rejected" ? "value-rejected" : "" } value={appointment.status} onChange={(e) => handleUpdateStatus(appointment._id, e.target.value) }>
