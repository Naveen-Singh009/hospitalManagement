...
const AppointmentForm = () => {
    ...
    const handleAppointment = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post("http://localhost:4000/api/v1/appointment/post", {
                ...
                appointment_date: appointmentDate, department, address, hasVisited: hasVisitedBool, doctor_firstName: doctorFirstName,
    ...
    return <>
        <div className='container form-component appointment-form'>
            <h2>Appointment</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic molestias est veritatis assumenda quam vitae?</p>
